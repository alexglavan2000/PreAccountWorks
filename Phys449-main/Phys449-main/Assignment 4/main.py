...
set1 = np.array(np.loadtxt('in.txt'))
...
x=4
while j<x:
    setnew.append(set1[0][j])
    j+=1
j=0

while j<x:
    setnew.append(set1[1][j])
    j+=1
j=0
while j<x:
    setnew.append(set1[2][j])
    j+=1
j=0

while j<x:
    setnew.append(set1[3][j])
    j+=1
j=0
while j<x:
    setnew.append(set1[4][j])
    j+=1
j=0
while j<x:
    setnew.append(set1[5][j])
    j+=1
j=0
while j<x:
    setnew.append(set1[6][j])
    j+=1
j=0
while j<x:
    setnew.append(set1[7][j])
    j+=1
j=0
while j<x:
    setnew.append(set1[8][j])
    j+=1
j=0
while j<x:
    setnew.append(set1[9][j])
    j+=1
    
#loading set c
set3 = np.array(np.loadtxt('in.txt'))
